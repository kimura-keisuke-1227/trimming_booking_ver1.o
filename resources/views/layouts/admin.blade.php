            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-gray-800 overflow-y-auto">
                ...
                <div class="px-4 pb-6">
                    ...
                    <ul class="mb-8 text-sm font-medium">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="{{ Route('admin.makebooking') }}">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="{{ Route('admin.checkCapacity')}}">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="{{Route('admin.adjustCapacity')}}">
                                <span class="inline-block mr-3">
