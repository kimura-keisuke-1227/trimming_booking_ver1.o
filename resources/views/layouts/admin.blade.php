        ...
        <div class="hidden lg:block navbar-menu relative z-50">
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-gray-800 overflow-y-auto">
                <h1 class="px-6 pb-6 mb-6 lg:border-b border-gray-700">
                    <a class="text-xl text-white font-semibold" href="<?php echo url('')?>/">トップ画面</a>
                </h1>
                <div class="px-4 pb-6">
                    <h3 class="mb-2 text-xs uppercase text-gray-500 font-medium">メニュー</h3>
                    <ul class="mb-8 text-sm font-medium">
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/admin/allbookings">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/admin/makebooking">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/admin/checkcapacities">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/admin/capacitysetting">
                                <span class="inline-block mr-3">
