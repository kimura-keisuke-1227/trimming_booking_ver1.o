...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/css/admin/tailwind/tailwind.min.css/css/admin/select2.min.css')}}">
        ...
        <div class="hidden lg:block navbar-menu relative z-50">
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-gray-800 overflow-y-auto">
                ...
                <div class="px-4 pb-6">
                    ...
                    <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="{{Route('user.newBooking')}}">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="{{Route('user.dog_register')}}">
                                <span class="inline-block mr-3">
