...
<head>
    ...
    <link rel="stylesheet" href="http://xs488546.xsrv.jp/test/trimming_booking_ver1.o/public/css/style.css" >
</head>
    ...
    <div>
                ...
                <header>
                    ...
                    {{--
                        <!-- <nav>
                            <ul>
                                <li><a href="/">トップ</a></li>
                                <li><a href="/new_booking">新規予約登録</a></li>
                                <li><a href="/bookings">予約確認</a></li>
                                <li><a href="/dog_register">ペット登録</a></li>
                                <li><a href="/pets">ペット確認</a></li>
                                <li>
        ...
        <nav class="lg:hidden py-6 px-6 bg-gray-800">
            <div class="flex items-center justify-between">
                <a class="text-2xl text-white font-semibold" href="/">トップ画面</a>
        ...
        <div class="hidden lg:block navbar-menu relative z-50">
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-gray-800 overflow-y-auto">
                ...
                <div class="px-4 pb-6">
                    ...
                    <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/new_booking">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/bookings">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/pets">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a class="flex items-center pl-3 py-3 pr-4 text-gray-50 hover:bg-gray-900 rounded" href="<?php echo url('')?>/dog_register">
                                <span class="inline-block mr-3">
