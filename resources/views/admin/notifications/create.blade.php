            ...
            <form action="{{Route('notification.store',[])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="address1" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="date" name="address1" value="">
                    </div>
                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2" for="name">表示終了日時</label>
                        <input id="address2" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="date" name="address2" value="">
                    </div>
                    <div class="ml-auto">
