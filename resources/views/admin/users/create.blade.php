            ...
            <form action="{{route('admin.users.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="last_name" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="last_name" placeholder="予約" value="{{ old('name') }}">
                        <input id="first_name" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="first_name" placeholder="太郎" value="{{ old('name') }}">
                    </div>
                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2" for="name">フリガナ(全角カナ)</label>
                        <input id="last_name_kana" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="last_name_kana" placeholder="ヨヤク" value="{{ old('name') }}">
                        <input id="first_name_kana" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="first_name_kana" placeholder="タロウ" value="{{ old('name') }}">
                    </div>
