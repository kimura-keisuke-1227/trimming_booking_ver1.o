            ...
            <form action="{{Route('admin.salon.update',['salon_id' => $salon -> id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="open_h" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="open_h" value="{{$open}}">
                    </div>
                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2" for="name">閉店時間(3または4桁で入力　18時なら1800)</label>
                        <input id="close_h" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="text" name="close_h" value="{{$close}}">
                    </div>
                    <div class="ml-auto">
